...
public class BookmarksDbOpenHelper extends SQLiteOpenHelper {
	...
	private void populateExampleBookmarks(SQLiteDatabase db) {
		db.execSQL("INSERT INTO bookmarkCategories (categoryName, description) VALUES ('调频电台', '调频广播电台');");
		db.execSQL("INSERT INTO bookmarkCategories (categoryName, description) VALUES ('收藏夹', '我收藏的电台');");
		//db.execSQL("INSERT INTO bookmarkCategories (categoryName, description) VALUES ('category3', 'Just for testing');");

		db.execSQL("INSERT INTO bookmarks (name, comment, categoryID, frequency, channelWidth, mode, squelch) VALUES ('书签', '我的电台', 1, 90800000, 100000, 3, -50);");
